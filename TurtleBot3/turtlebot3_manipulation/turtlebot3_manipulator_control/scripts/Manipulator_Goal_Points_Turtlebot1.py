...
Home2=[0.0,0.0,0.0,0.0]
Gripping_Position2=[3.14,-0.6,0.0,0.0]
Red_Position2=[2.5,-0.6,0.0,0.0]
Blue_Position2=[3.14,-0.6,0.0,0.0]
White_Position2=[3.5,-0.6,0.0,0.0]
...
sub_MQTT=rospy.Subscriber('/MQTT_msg',String,Read_MQTT)

def Read_Camera(data):
    global Camera_data
    Camera_data=data.data

sub_Camera=rospy.Subscriber('/Camera_msg',String,Read_Camera)

Gripping_Points=rospy.Publisher('/Manipulator_JointSpace_Goal',JointState,queue_size=1)
Gripping_Order=rospy.Publisher('/Manipulator_Gripper_Open_Close',Bool,queue_size=1)
Gripping_Status=rospy.Publisher('/Gripping_Status',String,queue_size=1)
